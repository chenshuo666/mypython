...
if __name__=='__main__':
    ...
    for min_samples_leaf in min_samples_leafs:
        ...
        K = 10
        scores = model_selection.cross_val_score(clf, X_train, Y_train, cv=K, scoring='accuracy', verbose=0, n_jobs=-1)
        # print('Scores = {}'.format(scores))
        print('Min_samples = {}, Avg score: {}'.format(min_samples_leaf, sum(scores) / len(scores)))
